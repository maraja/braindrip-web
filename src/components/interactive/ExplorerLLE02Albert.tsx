...
const DETAILS = [
    ...
    { label: 'Training data', detail: 'Same as BERT (BookCorpus + Wikipedia, ~16GB)' },
    { label: 'Results', detail: 'ALBERT-xxlarge achieved GLUE 89.4 (vs BERT-Large 82.1), SQuAD 2.0 F1 92.2, RACE 86.5' },
];

export default function ExplorerLLE02Albert() {
