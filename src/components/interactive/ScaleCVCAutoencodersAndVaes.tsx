...
export default function ScaleCVCAutoencodersAndVaes() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>How does Autoencoders and VAEs matter in practice?</p>
      {!revealed ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={{ padding: '0.75rem 1rem', background: '#C76B4A0C', borderRadius: 10, borderLeft: '3px solid #C76B4A' }}>
            <p style={{ fontSize: '0.82rem', color: '#2C3E2D', lineHeight: 1.5, margin: 0 }}><strong>Key Impact:</strong> Dimensionality reduction: Autoencoders learn nonlinear compressions superior to PCA for complex data like images. Generative modeling: VAEs provide a principled framework to sample new images by drawing z  &#123;N&#125;(0, I) and decoding.</p>
          </div>
        </div>
      )}
    </div>
