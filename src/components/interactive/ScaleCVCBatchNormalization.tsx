      ...
      {!revealed ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={{ padding: '0.75rem 1rem', background: '#C76B4A0C', borderRadius: 10, borderLeft: '3px solid #C76B4A' }}>
            <p style={{ fontSize: '0.82rem', color: '#2C3E2D', lineHeight: 1.5, margin: 0 }}><strong>Key Impact:</strong> BN allowed the original Inception-v2 to train 14x faster than the non-BN baseline while achieving the same accuracy. It enables learning rates 5-10x higher than possible without normalization, accelerating convergence substantially.</p>
          </div>
        </div>
      )}
    </div>
