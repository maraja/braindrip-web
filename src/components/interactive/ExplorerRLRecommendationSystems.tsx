...
const DETAILS = [
    { label: 'YouTube', detail: 'uses RL for video recommendation, optimizing for long-term watch time rather than immediate click probability (Chen et al., 2019). They report significant engagement improvements from the RL approach.' },
    { label: 'Spotify', detail: 'uses contextual bandits for playlist personalization, with Thompson sampling for exploration.' },
