...
const DETAILS = [
    ...
    { label: 'Organizational readiness', detail: 'Deploying RL requires buy-in from multiple teams (ML engineering, domain experts, operations, product). Lack of explainability is a common organizational barrier.' },
];

export default function ExplorerRLRlInProduction() {
