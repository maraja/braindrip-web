...
const DETAILS = [
    ...
    { label: 'Inference speed', detail: '~10 FPS on V100 with Swin-L backbone; ~20 FPS with Swin-T' },
    { label: 'Query count', detail: '900 queries selected per image, matching DINO\'s default' },
];

export default function ExplorerCVCGroundingDino() {
