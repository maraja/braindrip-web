...
const DETAILS = [
    { label: '2020 Landscape', detail: 'GPT-3 (text), ViT (images), Wav2Vec 2.0 (audio) — separate models, separate pipelines.' },
...
export default function ExplorerLLE05TheConvergenceTowardOmniModels() {
