...
export default function ScaleLGAToolSchemasAndValidation() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>How does Tool Schemas and Validation matter in practice?</p>
      {!revealed ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={{ padding: '0.75rem 1rem', background: '#C76B4A0C', borderRadius: 10, borderLeft: '3px solid #C76B4A' }}>
            <p style={{ fontSize: '0.82rem', color: '#2C3E2D', lineHeight: 1.5, margin: 0 }}><strong>Key Impact:</strong> Precision over guessing — field descriptions act as micro-prompts, steering the LLM toward correct parameter values. Input validation — constraints like ge, le, and max_length reject bad inputs before they reach your tool logic.</p>
          </div>
        </div>
      )}
    </div>
