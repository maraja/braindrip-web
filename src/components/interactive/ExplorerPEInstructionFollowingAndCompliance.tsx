...
const DETAILS = [
    { label: 'Numbered lists vs. prose', detail: 'Instructions formatted as numbered lists show 15-20% higher compliance than equivalent instructions in paragraph form.' },
...
export default function ExplorerPEInstructionFollowingAndCompliance() {
