...
const DETAILS = [
    ...
    { label: 'Repository context limits', detail: 'most agents can explore and understand repositories up to ~10K files. Beyond that, search and navigation becomes the bottleneck' },
];

export default function ExplorerAACAutonomousCodingAgents() {
