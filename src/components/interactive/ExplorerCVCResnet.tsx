...
const DETAILS = [
    ...
    { label: 'Global average pooling', detail: 'replaces fully connected layers (except the final 1000-way FC), following GoogLeNet.' },
    { label: 'ResNet-50', detail: 'has become the de facto benchmark model: 25.6M parameters, 4.1B FLOPs, and readily available pretrained in every major framework.' },
];

export default function ExplorerCVCResnet() {
