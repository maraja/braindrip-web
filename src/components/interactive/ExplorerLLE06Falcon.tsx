...
const DETAILS = [
    { label: 'Falcon-7B', detail: '7 billion parameters, trained on 1.5T tokens of RefinedWeb' },
    { label: 'Falcon-40B', detail: '40 billion parameters, 60 layers, d_model=8192, trained on 1T tokens' },
