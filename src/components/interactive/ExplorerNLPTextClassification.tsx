...
const DETAILS = [
    { label: 'AG News benchmark', detail: '4-class news classification; BERT achieves ~94.5% accuracy, linear SVM ~92%.' },
    { label: 'IMDB sentiment', detail: '(binary): BERT-family models reach ~95.5% accuracy; a simple BiLSTM with attention achieves ~90%.' },
