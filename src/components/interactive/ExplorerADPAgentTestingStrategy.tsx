...
const DETAILS = [
    ...
    { label: 'Regression detection sensitivity', detail: 'With 100-task evaluation suites run 3 times each, you can reliably detect 5-percentage-point quality changes within one nightly run.' },
];

export default function ExplorerADPAgentTestingStrategy() {
