...
const DETAILS = [
    { label: 'Beta parameter', detail: '$\\beta = 0.1$--$0.5$ controls the deviation from the reference policy. Lower $\\beta$ allows more deviation; higher $\\beta$ keeps the policy closer to the reference.' },
    { label: 'Training', detail: 'Standard supervised learning setup -- AdamW optimizer, learning rate $1 \\times 10^{-6}$ to $5 \\times 10^{-7}$, 1--3 epochs over preference data.' },
    ...
    { label: 'Distribution shift', detail: 'Because preferences were collected under a different policy (the SFT model), DPO faces an offline/off-policy learning challenge. As $\\pi_\\theta$ diverges from $\\pi_{\\text{SFT}}$, the preference data becomes less informative.' },
    ...
    <div style={{ fontFamily: "'Source Sans 3', system-ui, sans-serif", background: '#FDFBF7', border: '1px solid #E5DFD3', borderRadius: '14px', padding: '2rem', margin: '2.5rem 0' }}>
      <div style={{ marginBottom: '1.5rem' }}>
        ...
        <p style={{ fontSize: '0.88rem', color: '#5A6B5C', margin: '0.4rem 0 0 0', lineHeight: 1.6 }}>
          Click each card to explore the technical details of dpo as implicit rl.
        </p>
      </div>
