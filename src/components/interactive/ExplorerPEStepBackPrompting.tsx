...
const DETAILS = [
    { label: 'Physics (MMLU)', detail: 'Step-back prompting improved PaLM 2L accuracy by 7% over chain-of-thought baseline.' },
    { label: 'Chemistry (MMLU)', detail: 'Improvement of approximately 5% over standard CoT on chemistry reasoning questions.' },
