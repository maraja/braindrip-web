...
const DETAILS = [
    ...
    { label: 'Answer format dependency', detail: 'Works best when answers are discrete (numbers, categories, yes/no); less effective for open-ended text generation where answers cannot be easily compared.' },
];

export default function ExplorerPESelfConsistency() {
