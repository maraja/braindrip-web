...
const DETAILS = [
    { label: 'Common orders', detail: 'Bigrams and trigrams are most common in practice. 4-grams and 5-grams are used in speech recognition with massive corpora. Beyond 5-grams, data sparsity makes estimation unreliable even with smoothing.' },
