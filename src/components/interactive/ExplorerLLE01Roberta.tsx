...
const DETAILS = [
    ...
    { label: 'Batch size', detail: '8,192 sequences (vs BERT\'s 256)' },
    { label: 'Training steps', detail: '500K steps (vs BERT\'s 1M, but with much larger batches — ~31x more tokens seen)' },
];

export default function ExplorerLLE01Roberta() {
