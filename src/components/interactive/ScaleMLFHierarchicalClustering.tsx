...
export default function ScaleMLFHierarchicalClustering() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>How does Hierarchical Clustering matter in practice?</p>
      {!revealed ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={{ padding: '0.75rem 1rem', background: '#C76B4A0C', borderRadius: 10, borderLeft: '3px solid #C76B4A' }}>
            <p style={{ fontSize: '0.82rem', color: '#2C3E2D', lineHeight: 1.5, margin: 0 }}><strong>Key Impact:</strong> Hierarchical clustering is indispensable when the data has multi-scale structure -- for instance, in taxonomy (species, genus, family), document organization, or gene expression analysis. It requires no a priori choice of K, and the dendrogram provides a rich, interpretable summary of data relationships.</p>
          </div>
        </div>
      )}
    </div>
