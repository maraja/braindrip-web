...
export default function ScaleNLPPrivacyInNlp() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>How does Privacy in NLP matter in practice?</p>
      {!revealed ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={{ padding: '0.75rem 1rem', background: '#C76B4A0C', borderRadius: 10, borderLeft: '3px solid #C76B4A' }}>
            <p style={{ fontSize: '0.82rem', color: '#2C3E2D', lineHeight: 1.5, margin: 0 }}><strong>Key Impact:</strong> Legal compliance: GDPR, HIPAA, CCPA, and similar regulations impose strict requirements on handling personal data, with fines up to 4% of global annual revenue for GDPR violations. Patient safety: Clinical NLP systems that leak patient information violate medical confidentiality and can cause tangible harm to individuals.</p>
          </div>
        </div>
      )}
    </div>
