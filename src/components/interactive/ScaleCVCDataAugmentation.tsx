...
export default function ScaleCVCDataAugmentation() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>How does Data Augmentation matter in practice?</p>
      {!revealed ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={{ padding: '0.75rem 1rem', background: '#C76B4A0C', borderRadius: 10, borderLeft: '3px solid #C76B4A' }}>
            <p style={{ fontSize: '0.82rem', color: '#2C3E2D', lineHeight: 1.5, margin: 0 }}><strong>Key Impact:</strong> On CIFAR-10, augmentation alone can close 30-50% of the gap between a baseline and a state-of-the-art result. For small datasets (&lt; 10k images), augmentation is often the difference between a usable model and a failed one.</p>
          </div>
        </div>
      )}
    </div>
