...
const DETAILS = [
    ...
    { label: 'Model fallback chains', detail: 'configure a primary model with fallbacks: if Claude Sonnet returns a 503, fall back to GPT-4o; if that fails, fall back to a local model for critical paths' },
    { label: 'Secret rotation', detail: 'must not require redeployment: use a secrets manager (AWS Secrets Manager, HashiCorp Vault) and refresh credentials at runtime' },
];

export default function ExplorerAACAgentDeployment() {
