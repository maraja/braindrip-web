...
const DETAILS = [
    ...
    { label: 'Timeout configuration', detail: 'Set aggressive timeouts (5-15 seconds) for API calls. An agent waiting 60 seconds for a hung API creates a terrible user experience. Fail fast and inform the model.' },
];

export default function ExplorerAACApiIntegration() {
