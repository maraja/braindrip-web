...
const DETAILS = [
    ...
    { label: 'Training efficiency', detail: '~4x more sample-efficient than MLM due to all-token discrimination' },
    { label: 'Generator size', detail: '1/4 to 1/3 of discriminator (smaller generators work better — too-good generators make the discrimination task too hard)' },
];

export default function ExplorerLLE05Electra() {
