...
const DETAILS = [
    { label: 'Penn Treebank (English, Stanford Dependencies)', detail: 'SOTA ~96% UAS, ~94.5% LAS (biaffine parser with BERT).' },
    { label: 'Universal Dependencies', detail: 'Average ~92% UAS across high-resource languages; drops to ~70--80% for low-resource languages.' },
