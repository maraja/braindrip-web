...
const DETAILS = [
    { label: 'Published', detail: '2023 by Rafailov et al. at Stanford University' },
    { label: 'Core insight', detail: 'RLHF objective can be reformulated as classification loss on preference pairs' },
