...
export default function AnalogyCVCMobilenet() {
  ...
  const analogies = [
    { emoji: '🏗', label: 'Building', text: 'Think of MobileNet like constructing a building. Think of designing a car for city driving. A Formula 1 car has incredible performance but is impractical for daily use -- too expensive, too wide f... Just as a builder follows blueprints to create a structure, this concept provides the foundational framework that everything else builds upon.' },
    { emoji: '🎭', label: 'Theater', text: 'MobileNet is like directing a theater production. Think of designing a car for city driving. A Formula 1 car has incredible performance but is impractical for daily use -- too expensive, too wide f... Each element plays a specific role, and the overall performance depends on how well they work together.' },
    { emoji: '🗺', label: 'Navigation', text: 'Think of MobileNet like navigating with a map. Think of designing a car for city driving. A Formula 1 car has incredible performance but is impractical for daily use -- too expensive, too wide f... You need to understand where you are, where you want to go, and the best route to get there.' },
  ];
  return (
    <div style={baseStyle}>
