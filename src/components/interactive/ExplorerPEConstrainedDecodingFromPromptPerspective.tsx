...
const DETAILS = [
    { label: 'Constrained decoding adds 5-15% latency overhead', detail: 'due to grammar checking at each token position, though optimized implementations minimize this.' },
    { label: 'Outlines achieves 100% structural validity', detail: 'for any JSON Schema that can be expressed as a context-free grammar.' },
