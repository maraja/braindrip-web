...
const DETAILS = [
    { label: 'Convex loss', detail: 'Cross-entropy is convex, so any local minimum is the global minimum.' },
    { label: 'No closed-form solution', detail: 'Must use iterative optimization (gradient descent, Newton\'s method, L-BFGS).' },
