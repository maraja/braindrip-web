...
const DETAILS = [
    ...
    { label: 'ConvS2S (Gehring et al., 2017)', detail: '40.51 BLEU on WMT\'14 En-Fr (vs. 38.95 for GNMT with attention). Trained in 1.5 days on 8 GPUs vs. 14 days for the RNN baseline.' },
    ...
    <div style={{ fontFamily: "'Source Sans 3', system-ui, sans-serif", background: '#FDFBF7', border: '1px solid #E5DFD3', borderRadius: '14px', padding: '2rem', margin: '2.5rem 0' }}>
      <div style={{ marginBottom: '1.5rem' }}>
        ...
        <p style={{ fontSize: '0.88rem', color: '#5A6B5C', margin: '0.4rem 0 0 0', lineHeight: 1.6 }}>
          Click each card to explore the technical details of convolutional models for text.
        </p>
      </div>
