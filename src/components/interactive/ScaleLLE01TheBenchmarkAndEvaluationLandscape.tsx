...
export default function ScaleLLE01TheBenchmarkAndEvaluationLandscape() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>Understanding The Benchmark and Evaluation Landscape has real implications for how AI systems are built and deployed. What makes this concept especially important in practice?</p>
      {!revealed ? (
        ...
        <div style={{ padding: '0.75rem 1rem', background: '#C76B4A' + '0C', borderRadius: 10, borderLeft: '3px solid #C76B4A' }}>
          <p style={{ fontSize: '0.9rem', color: '#2C3E2D', lineHeight: 1.5, margin: 0, fontWeight: 500 }}>### The Saturation Cycle  The recurring pattern — new benchmark, rapid improvement, saturation, replacement — reveals something fundamental about LLMs: they are exceptionally good at learning to pass tests. MMLU went from challenging to saturated in four years.</p>
        </div>
      )}
    </div>
  );
