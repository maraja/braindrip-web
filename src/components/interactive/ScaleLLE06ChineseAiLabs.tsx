...
export default function ScaleLLE06ChineseAiLabs() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>How does Chinese AI Labs: The Global Competition Landscape matter in practice?</p>
      {!revealed ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={{ padding: '0.75rem 1rem', background: '#C76B4A0C', borderRadius: 10, borderLeft: '3px solid #C76B4A' }}>
            <p style={{ fontSize: '0.82rem', color: '#2C3E2D', lineHeight: 1.5, margin: 0 }}><strong>Key Impact:</strong> The Chinese AI lab ecosystem matters because it transformed AI from a Western-dominated field into a genuinely global, multi-polar competition. By 2025, the monthly aggregate paper output from Chinese AI institutions exceeded that of US institutions in quantity, and the quality gap on frontier capabilities had narrowed to the point of rough parity on many benchmarks.</p>
          </div>
        </div>
      )}
    </div>
