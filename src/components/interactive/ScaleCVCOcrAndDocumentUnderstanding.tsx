...
export default function ScaleCVCOcrAndDocumentUnderstanding() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>How does OCR and Document Understanding matter in practice?</p>
      {!revealed ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={{ padding: '0.75rem 1rem', background: '#C76B4A0C', borderRadius: 10, borderLeft: '3px solid #C76B4A' }}>
            <p style={{ fontSize: '0.82rem', color: '#2C3E2D', lineHeight: 1.5, margin: 0 }}><strong>Key Impact:</strong> OCR processes an estimated 2.5 trillion pages annually across banking, insurance, healthcare, and legal industries. Automated invoice processing reduces manual data entry costs by 70--80% and processing time from days to seconds.</p>
          </div>
        </div>
      )}
    </div>
