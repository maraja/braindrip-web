...
export default function ScaleMLFFeatureExtractionAndTransformation() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>How does Feature Extraction and Transformation matter in practice?</p>
      {!revealed ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={{ padding: '0.75rem 1rem', background: '#C76B4A0C', borderRadius: 10, borderLeft: '3px solid #C76B4A' }}>
            <p style={{ fontSize: '0.82rem', color: '#2C3E2D', lineHeight: 1.5, margin: 0 }}><strong>Key Impact:</strong> In Kaggle competitions and industry applications alike, feature engineering frequently determines the gap between a mediocre model and a winning one. Andrew Ng has noted that "coming up with features is difficult, time-consuming, requires expert knowledge." Yet it remains the stage where human insight adds the most value.</p>
          </div>
        </div>
      )}
    </div>
