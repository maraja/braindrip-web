...
export default function ScaleLLE01AttentionIsAllYouNeed() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>How does Attention Is All You Need matter in practice?</p>
      {!revealed ? (
