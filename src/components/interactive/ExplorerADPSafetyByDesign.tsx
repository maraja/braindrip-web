...
const DETAILS = [
    ...
    { label: 'Credential rotation', detail: 'every 1-4 hours for agent service accounts reduces the blast radius of credential compromise to at most a few hours of unauthorized access.' },
];

export default function ExplorerADPSafetyByDesign() {
