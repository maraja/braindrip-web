...
const DETAILS = [
    { label: 'Chain-of-thought before classification improves accuracy by 5-10%', detail: 'on ambiguous tasks, with the largest gains on inputs near decision boundaries.' },
    { label: 'Label space size impacts accuracy', detail: 'models handle 5-10 categories well, 10-20 with slight degradation, and 20+ with noticeable accuracy drops requiring hierarchical approaches.' },
