...
export default function ScaleNLPBidirectionalRnns() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>How does Bidirectional RNNs matter in practice?</p>
      {!revealed ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={{ padding: '0.75rem 1rem', background: '#C76B4A0C', borderRadius: 10, borderLeft: '3px solid #C76B4A' }}>
            <p style={{ fontSize: '0.82rem', color: '#2C3E2D', lineHeight: 1.5, margin: 0 }}><strong>Key Impact:</strong> State-of-the-art for sequence labeling: Before transformers, BiLSTMs (often with a CRF output layer) were the dominant architecture for NER, POS tagging, and chunking. (2015) established the BiLSTM-CRF as the standard approach.</p>
          </div>
        </div>
      )}
    </div>
