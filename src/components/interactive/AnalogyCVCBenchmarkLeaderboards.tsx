...
export default function AnalogyCVCBenchmarkLeaderboards() {
  ...
  const analogies = [
    { emoji: '🏗', label: 'Building', text: 'Think of Benchmark Leaderboards like constructing a building. Imagine a scoreboard in a sports league: every team plays the same game under the same rules, and rankings are clear. Benchmark leaderboards serve ... Just as a builder follows blueprints to create a structure, this concept provides the foundational framework that everything else builds upon.' },
    { emoji: '🎭', label: 'Theater', text: 'Benchmark Leaderboards is like directing a theater production. Imagine a scoreboard in a sports league: every team plays the same game under the same rules, and rankings are clear. Benchmark leaderboards serve ... Each element plays a specific role, and the overall performance depends on how well they work together.' },
    { emoji: '🗺', label: 'Navigation', text: 'Think of Benchmark Leaderboards like navigating with a map. Imagine a scoreboard in a sports league: every team plays the same game under the same rules, and rankings are clear. Benchmark leaderboards serve ... You need to understand where you are, where you want to go, and the best route to get there.' },
  ];
  return (
    <div style={baseStyle}>
