...
const DETAILS = [
    { label: 'Benchmark results', detail: '10-15% improvement on multi-hop QA benchmarks (Bamboogle, Musique) compared to standard CoT with PaLM and GPT-3.' },
    { label: 'Few-shot examples', detail: '3-5 examples demonstrating the full decomposition-synthesis pattern typically suffice to establish the self-ask format.' },
