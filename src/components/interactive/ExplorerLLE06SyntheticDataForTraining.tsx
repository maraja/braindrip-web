...
const DETAILS = [
    ...
    { label: 'DeepSeek-R1 (2025)', detail: 'RL-discovered reasoning traces used as synthetic training data' },
];

export default function ExplorerLLE06SyntheticDataForTraining() {
