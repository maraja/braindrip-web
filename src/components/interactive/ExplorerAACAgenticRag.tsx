...
const DETAILS = [
    ...
    { label: 'Context window management', detail: 'As multiple retrieval rounds accumulate documents, the agent must manage context window limits by summarizing, pruning, or prioritizing the most relevant passages.' },
    { label: 'Retrieval metadata', detail: 'The agent tracks which sources contributed to each part of its answer, enabling citation and attribution in the final response.' },
];

export default function ExplorerAACAgenticRag() {
