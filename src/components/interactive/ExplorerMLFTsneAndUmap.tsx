...
const DETAILS = [
    ...
    { label: 'Barnes-Hut approximation (t-SNE)', detail: 'The naive t-SNE gradient computation is O(n^2). The Barnes-Hut approximation reduces this to O(n  n) by grouping distant points, making t-SNE practical for datasets up to ~100K points.' },
];
