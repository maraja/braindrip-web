...
export default function AnalogyPECodeReviewAndDebuggingPrompts() {
  ...
  const analogies = [
    { emoji: '🏗', label: 'Building', text: 'Think of Code Review and Debugging Prompts like constructing a building. Think of the distinction like a proofreader versus a writer. A writer creates new text from a blank page; a proofreader examines existing text for ... Just as a builder follows blueprints to create a structure, this concept provides the foundational framework that everything else builds upon.' },
    { emoji: '🎭', label: 'Theater', text: 'Code Review and Debugging Prompts is like directing a theater production. Think of the distinction like a proofreader versus a writer. A writer creates new text from a blank page; a proofreader examines existing text for ... Each element plays a specific role, and the overall performance depends on how well they work together.' },
    { emoji: '🗺', label: 'Navigation', text: 'Think of Code Review and Debugging Prompts like navigating with a map. Think of the distinction like a proofreader versus a writer. A writer creates new text from a blank page; a proofreader examines existing text for ... You need to understand where you are, where you want to go, and the best route to get there.' },
  ];
  return (
    <div style={baseStyle}>
