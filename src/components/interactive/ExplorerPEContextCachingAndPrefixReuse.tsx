...
const DETAILS = [
    { label: 'Anthropic\'s prompt caching provides up to 90% cost reduction', detail: 'on cached tokens, with a 5-minute TTL extended by cache hits.' },
    { label: 'OpenAI\'s automatic caching activates for prompts over 1,024 tokens', detail: ', providing 50% cost reduction on cached tokens.' },
