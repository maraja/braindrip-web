...
export default function ScaleNLPAmbiguityInLanguage() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>How does Ambiguity in Language matter in practice?</p>
      {!revealed ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={{ padding: '0.75rem 1rem', background: '#C76B4A0C', borderRadius: 10, borderLeft: '3px solid #C76B4A' }}>
            <p style={{ fontSize: '0.82rem', color: '#2C3E2D', lineHeight: 1.5, margin: 0 }}><strong>Key Impact:</strong> Machine translation: "I saw her duck" could be translated five different ways depending on interpretation. MT systems must resolve ambiguity before generating the target language, where the ambiguity may not exist (see machine-translation.md).</p>
          </div>
        </div>
      )}
    </div>
