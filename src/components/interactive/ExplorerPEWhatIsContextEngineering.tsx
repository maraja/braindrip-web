...
const DETAILS = [
    { label: 'Context windows range from 8K to 200K+ tokens', detail: 'across current frontier models, with effective performance often degrading before the nominal limit.' },
    { label: 'Prompt instructions typically occupy 5-15% of the context', detail: 'in production applications; the remaining 85-95% is engineered context.' },
