...
const DETAILS = [
    ...
    { label: 'Temperature-based action selection', detail: 'At the root, actions are selected proportionally to $N(s,a)^{1/\\tau}$ where $\\tau$ is a temperature parameter. Early in the game $\\tau = 1$ encourages exploration; later $\\tau \\to 0$ selects the most-visited action deterministically.' },
    ...
    { label: 'Dirichlet noise', detail: 'AlphaZero adds Dirichlet noise to the root prior: $P\'(a) = (1 - \\epsilon) P(a|s) + \\epsilon \\cdot \\eta_a$, where $\\eta \\sim \\text{Dir}(\\alpha)$ with $\\alpha = 0.03$ for Go, ensuring root-level exploration during self-play.' },
];
    ...
    <div style={{ fontFamily: "'Source Sans 3', system-ui, sans-serif", background: '#FDFBF7', border: '1px solid #E5DFD3', borderRadius: '14px', padding: '2rem', margin: '2.5rem 0' }}>
      <div style={{ marginBottom: '1.5rem' }}>
        ...
        <p style={{ fontSize: '0.88rem', color: '#5A6B5C', margin: '0.4rem 0 0 0', lineHeight: 1.6 }}>
          Click each card to explore the technical details of monte carlo tree search.
        </p>
      </div>
