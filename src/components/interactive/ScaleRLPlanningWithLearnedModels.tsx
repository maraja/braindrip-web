...
export default function ScaleRLPlanningWithLearnedModels() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>How does Planning with Learned Models matter in practice?</p>
      {!revealed ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
          <div style={{ padding: '0.75rem 1rem', background: '#C76B4A0C', borderRadius: 10, borderLeft: '3px solid #C76B4A' }}>
            <p style={{ fontSize: '0.82rem', color: '#2C3E2D', lineHeight: 1.5, margin: 0 }}><strong>Key Impact:</strong> Planning with learned models offers the potential for orders-of-magnitude better sample efficiency compared to model-free RL. MBPO achieves the same performance as SAC with 10-100x fewer environment interactions on MuJoCo benchmarks.</p>
          </div>
        </div>
      )}
    </div>
