...
const DETAILS = [
    ...
    { label: 'Context length', detail: '8,192 tokens (vs BERT\'s 512) — 16x increase' },
    { label: 'Architecture innovations', detail: 'RoPE, Flash Attention 2, GeGLU activations, unpadding, alternating local/global attention' },
];

export default function ExplorerLLE06ModernbertAndTheEncoderRevival() {
