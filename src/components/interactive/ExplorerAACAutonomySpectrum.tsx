...
const DETAILS = [
    ...
    { label: 'Monitoring overhead', detail: 'Semi-autonomous agents require logging of all tool calls and outputs. Typical implementations log 500-5,000 lines per task for post-hoc review.' },
];

export default function ExplorerAACAutonomySpectrum() {
