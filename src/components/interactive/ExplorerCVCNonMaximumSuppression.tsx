...
const DETAILS = [
    ...
    { label: 'Speed', detail: 'Greedy NMS on 1,000 boxes takes ~0.5-1ms on CPU, but batched GPU implementations (e.g., torchvision.ops.nms) run in ~0.1ms.' },
    { label: 'DETR eliminates NMS', detail: 'by using set-based prediction with bipartite matching -- a fundamentally different approach.' },
];

export default function ExplorerCVCNonMaximumSuppression() {
