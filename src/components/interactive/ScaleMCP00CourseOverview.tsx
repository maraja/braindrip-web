...
export default function ScaleMCP00CourseOverview() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>How does Building MCP Servers on Supabase: A Comprehensive Course matter in practice?</p>
      {!revealed ? (
