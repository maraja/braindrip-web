...
export default function AnalogyNLPDataAnnotationAndLabeling() {
  ...
  const analogies = [
    { emoji: '🏗', label: 'Building', text: 'Think of Data Annotation and Labeling like constructing a building. Imagine teaching a child to recognize animals by showing them thousands of photographs, each carefully labeled: "dog," "cat," "horse." The quality ... Just as a builder follows blueprints to create a structure, this concept provides the foundational framework that everything else builds upon.' },
    { emoji: '🎭', label: 'Theater', text: 'Data Annotation and Labeling is like directing a theater production. Imagine teaching a child to recognize animals by showing them thousands of photographs, each carefully labeled: "dog," "cat," "horse." The quality ... Each element plays a specific role, and the overall performance depends on how well they work together.' },
    { emoji: '🗺', label: 'Navigation', text: 'Think of Data Annotation and Labeling like navigating with a map. Imagine teaching a child to recognize animals by showing them thousands of photographs, each carefully labeled: "dog," "cat," "horse." The quality ... You need to understand where you are, where you want to go, and the best route to get there.' },
  ];
  return (
    <div style={baseStyle}>
