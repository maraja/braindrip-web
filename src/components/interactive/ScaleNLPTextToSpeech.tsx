...
export default function ScaleNLPTextToSpeech() {
  ...
  return (
    <div style={baseStyle}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#3D4F3E', lineHeight: 1.5, marginBottom: 12 }}>How does Text-to-Speech matter in practice?</p>
      {!revealed ? (
