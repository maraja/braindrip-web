...
const DETAILS = [
    ...
    { label: 'Strategic repetition of critical instructions', detail: '(at beginning and end of context) recovers 60-80% of the adherence loss from the middle-loss effect.' },
    { label: 'Newer models', detail: '(GPT-4 Turbo, Claude 3.5, Gemini 1.5 Pro) show reduced but not eliminated middle-loss effects compared to earlier long-context models.' },
];

export default function ExplorerPEInformationPriorityAndOrdering() {
