...
const DETAILS = [
    ...
    { label: 'Query routing vs parallel execution', detail: 'Some systems route queries to the best strategy (using a query classifier), while others run all strategies in parallel and fuse. Parallel execution is simpler and more robust; routing is faster but risks misclassification.' },
