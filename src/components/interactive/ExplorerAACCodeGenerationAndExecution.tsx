...
const DETAILS = [
    { label: 'Language choice', detail: 'Python dominates due to its data science ecosystem (pandas, numpy, matplotlib, scikit-learn) and LLMs\' extensive training on Python code. JavaScript is used for web-related tasks. Shell commands serve for system operations.' },
...
export default function ExplorerAACCodeGenerationAndExecution() {
