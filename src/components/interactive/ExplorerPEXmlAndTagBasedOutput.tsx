...
const DETAILS = [
    { label: 'Anthropic\'s Claude models achieve near-100% XML format compliance', detail: 'when the prompt itself uses XML tags to structure instructions.' },
    { label: 'XML token overhead is approximately 15-25% more than plain text', detail: ', compared to JSON\'s 30% overhead — XML tags are generally shorter than JSON\'s structural syntax.' },
