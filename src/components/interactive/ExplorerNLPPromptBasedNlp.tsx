...
const DETAILS = [
    ...
    { label: 'Prefix tuning efficiency', detail: '1% of trainable parameters (prefix vectors) vs. 100% for full fine-tuning, with comparable performance on GPT-2-Large for table-to-text and summarization.' },
