...
const DETAILS = [
    ...
    { label: 'Training', detail: 'T5-11B trained for ~1 trillion tokens; estimated $1.3M in TPU compute' },
    { label: 'Results', detail: 'SOTA or near-SOTA on GLUE (90.3), SuperGLUE (88.9), SQuAD (93.8 F1), CNN/DailyMail (summarization), WMT EN-DE (BLEU 30.9)' },
];

export default function ExplorerLLE05T5TextToTextFramework() {
