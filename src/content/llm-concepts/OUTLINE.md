...
All 156 concepts organized by category. Each entry links to its deep-dive file and includes a one-line summary.
...
## 03 - Training Fundamentals (17 concepts)
...
| [Data Mixing & Domain Weighting](03-training-fundamentals/data-mixing.md) | Domain proportions in pre-training data impact model quality as much as architecture or scale. |
...
## 08 - Practical Applications (12 concepts)
...
| [Model Context Protocol](08-practical-applications/model-context-protocol.md) | Open standard providing a universal interface for connecting LLM applications to external tools and data sources. |
...
## 11 - Advanced & Emerging (27 concepts)
...
| [Mixture of Agents](11-advanced-and-emerging/mixture-of-agents.md) | Multiple LLMs in layered rounds refining each other's outputs to exceed any individual model's quality. |
