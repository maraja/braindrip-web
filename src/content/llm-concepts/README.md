...
A comprehensive reference of **156 concepts** covering the full landscape of Large Language Models -- from foundational transformer architecture to cutting-edge research in reasoning, alignment, and retrieval.
...
| 03 | [Training Fundamentals](03-training-fundamentals/) | 17 | Pre-training, optimization, scaling laws, emergent abilities, data curation, data mixing |
...
| 08 | [Practical Applications](08-practical-applications/) | 12 | RAG, agents, tool use, prompt engineering, memory systems, MCP |
...
| 11 | [Advanced & Emerging](11-advanced-and-emerging/) | 27 | Reasoning models, GraphRAG, mechanistic interpretability, state-space models, mixture of agents |
...
See [OUTLINE.md](OUTLINE.md) for the complete list of all 156 concepts with one-line summaries.
