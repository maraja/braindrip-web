...
![The three stages of LLM development: pretraining, supervised fine-tuning, and RLHF alignment](https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/blog/rlhf/pretraining.png)
