...
Fine-grained MoE: 256 small experts + 1 shared expert, top-8 routing → 9 active
```

Shared experts handle common, general-purpose computations that benefit every token (basic syntax, common patterns), while routed experts specialize in narrower skills. This separation improves both quality and routing stability.
