...
![Multiple attention heads operating in parallel, each with its own Q, K, V projections capturing different relationship types](https://jalammar.github.io/images/t/transformer_attention_heads_qkv.png)
